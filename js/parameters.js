...
let params = [
    ...
    new Param(22, 'Arp/Seq Swing', Slider(0, 16383, 8192)),
    ...
    new Param(27, 'Arp/Seq Clock Output', Options(['Always', 'Only When Playing'], 0)),
    new Param(28, 'Arp MIDI Control Mode', Options(['Arp outputs MIDI notes, ignores incoming MIDI notes when local control off', 'Arp doesn’t output MIDI notes, is controlled by incoming MIDI notes when local control is off'], 0)),
    ...
    new Param(34, 'Pitch Bend Range (Semitones)', Options(Range(0, 12), 2)),
    ...
    new Param(47, 'Multi Trig Reset Speed', Slider(4, 50, 4)),
];
