...
You can use the [editor here](https://marcora.github.io/grandmother-editor/index.html). 
...
This editor is a modification of the [Moog Matriarch Global Settings Editor](https://mreid.github.io/matriarch-editor/) written over a weekend by Mark Reid (who is **not** a web developer). 
